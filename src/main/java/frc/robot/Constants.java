...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final HolonomicPathFollowerConfig pathConfig =
        new HolonomicPathFollowerConfig( // HolonomicPathFollowerConfig, this should likely live in
            // your Constants class
            new PIDConstants(1.0, 0.0, 0.0), // Translation PID constants
            new PIDConstants(1.0, 0.0, 0.0), // Rotation PID constants
            4.5, // Max module speed, in m/s
            0.93, // Drive base radius in meters. Distance from robot center to furthest module.
  ...
  public static final class OIConstants {
    ...
    public static final int kMechanismBoxBluePort = 1;
    public static final int kMechanismBoxRedPort = 2;
    public static final int kDebugControllerPort = 1;
  ...
  public static final class ElbowConstants {
    ...
    public static final double defaultSpeedElbow = 0.9;
  }
